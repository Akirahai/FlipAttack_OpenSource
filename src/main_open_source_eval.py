...
def process_evaluation_batch(result_dicts, evaluator, checkpoint_file_name, eval_type):
    ...
    for batch_idx, batch_start in enumerate(range(begin, end, args.batch), start=1):
        ...
        batch_harmful_prompts, batch_flip_attacks, batch_response = [], [], []
...
if __name__ == "__main__":
    ...
    # FlipAttack Results
    parser.add_argument("--result_file", type=str, help ="The directory of FlipAttack results", default="final_result.json")
